...
- Поточне повідомлення є коротким уточненням в цій дискусії ("Це та модель?", "Точно?", "А версія X?", "Це зеро?", "Чи 5?")
...
- КРИТИЧНО: якщо повідомлення складається з 1-3 слів + "?" і CONTEXT містить активне обговорення тієї ж теми → це уточнення між людьми, consider=false
