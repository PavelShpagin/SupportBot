...
- updates: масив існуючих кейсів з новою інформацією, кожен з:
  ...
  - solution_summary: рядок (доповнений опис рішення)
...
- Якщо бачиш тред що вже покритий існуючим кейсом → ПРОПУСТИ (навіть якщо з'явились нові повідомлення)
- Для оновлення існуючих кейсів використовуй "updates", а не "new_cases"
...
ПРАВИЛА ДЛЯ updates:
- Якщо буфер містить СУТТЄВО нову інформацію для існуючого кейсу → додай в updates
