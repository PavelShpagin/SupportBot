...
- status="solved" якщо БУДЬ-ЯКА з умов виконана:
    ...
    * Автор питання підтвердив що порада спрацювала
- status="recommendation" якщо:
    * Людина дала пораду/рекомендацію/інструкцію по суті
    * АЛЕ автор питання НЕ підтвердив результат (немає "дякую", "працює", reactions=0)
    * Є solution_summary (порада що була дана), але без підтвердження що вона спрацювала
    * Людина вказала куди звернутись або що передати (без підтвердження)
