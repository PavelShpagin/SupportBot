...
- Поточне повідомлення є коротким уточненням в цій дискусії (напр. "Це та модель?", "Точно?", "А версія X?")
...
- КРИТИЧНО: якщо у CONTEXT хтось вже надає поради чи пояснення з тієї самої теми → consider=false, навіть якщо є "?"
...
- КРИТИЧНО: якщо повідомлення дуже коротке і неповне без CONTEXT → це уточнення між людьми, consider=false
