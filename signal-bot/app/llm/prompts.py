...
часто означають запит на допомогу.
"""
...
Якщо надані зображення, аналізуй їх уважно і використовуй видимі деталі.
Не вигадуй факти за межами кейсів, контексту та зображень.
"""
