        ...
        if req.is_refresh:
            ...
            if lang == "uk":
                caption = (
                    ...
                    "QR-код дійсний ~1 хв. Якщо не встигнете — надішлю новий автоматично (до 10 хв)."
                )
            else:
                caption = (
                    ...
                    "QR code valid for ~1 min. If it expires, a new one will be sent automatically (up to 10 min)."
                )
