...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        model_blocks_fallback=_parse_model_list(
            _env("MODEL_BLOCKS_FALLBACK", default="gemini-2.5-pro,gemini-3-flash-preview,gemini-2.0-flash-001")
        ),
        model_img=_env("MODEL_IMG", default="gemini-2.5-flash"),
        model_img_fallback=_parse_model_list(
            _env("MODEL_IMG_FALLBACK", default="gemini-3-flash-preview,gemini-2.0-flash-001")
        ),
        ...
        signal_bot_e164=_env("SIGNAL_BOT_E164", default=""),
        # Signal Desktop
